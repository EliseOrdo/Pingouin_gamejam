...
class Cible:
    ...
    def __init__(self, x, y):
        ...
        self.liste = [Cible(random.randint(0, 800), random.randint(0, 1000)) for i in range (pingcibles)]
...
while runningf:
    for event in pg.event.get():
        ...
        if event.type == pg.KEYDOWN:
            ...
            for cible in Cible.liste:
                cible.touche_cible(ping for ping in liste_pingouins)
